package
{
	...
	public class Level
	{
		...
		{
			var _currentPlayer:Player = new Player(); _currentPlayer.startupPlayer(new Point(0, 0)); GameObject.currentPlayer = _currentPlayer;
			new Player().startupPlayer(new Point(50,50));
